function [c, stimseq] = HPScript_buildStimCache(stimlist, reps, tdt, caldata, indev, outdev)
%--------------------------------------------------------------------------
% [c, stimseq] = HPScript_buildStimCache(stimlist, reps, tdt, caldata, indev, outdev)
%--------------------------------------------------------------------------
% HPSearch program
% TytoLogy project
%--------------------------------------------------------------------------
% Generates stimulus cache using stimlist
% 
%--------------------------------------------------------------------------
% Input Arguments:
% 	stimlist			stimulus parameters list cell array
% 	reps				stimulus data structure
...
% file created	18 June, 2012 from HPCurve_buildStimCache.m
%
%--------------------------------------------------------------------------
% Revision History
%--------------------------------------------------------------------------
...
c.reps = reps;
% # of trials == # of stim types
c.ntrials = length(stimlist);
