...
%-------------------------------------------------------------------------
function p = labpathdef
	labpath = 'K:\TytoLogy\main\'
% 	labpath = 'C:\Users\TytoLogy\'
	...
	p = [...
		%%% BEGIN ENTRIES %%%
			...
			[labpath ';'], ...
			[labpath 'Toolbox;'], ...
			[labpath 'Toolbox\BinaryFileToolbox;'], ...
			[labpath 'Toolbox\Audio;'], ...
			[labpath 'Toolbox\Audio\Calibration;'], ...
			[labpath 'Toolbox\Audio\FFT;'], ...
			[labpath 'Toolbox\Audio\Filter;'], ...
			[labpath 'Toolbox\Audio\Synthesis;'], ...
			[labpath 'Toolbox\Audio\Utils;'], ...
			[labpath 'Toolbox\Multiplexer;'], ...
			[labpath 'Toolbox\SpeakerLocations;'], ...
			[labpath 'Toolbox\TDT\Functions;'], ...
			[labpath 'Toolbox\TDT\Functions\InputOutput;'], ...
			[labpath 'Toolbox\TDT\Functions\PA5;'], ...
			[labpath 'Toolbox\TDT\Functions\RP;'], ...
			[labpath 'Toolbox\TDT\Functions\RX5;'], ...
			[labpath 'Toolbox\TDT\Functions\RX6;'], ...
			[labpath 'Toolbox\TDT\Functions\RX8;'], ...
			[labpath 'Toolbox\TDT\Functions\Robot;'], ...
			[labpath 'Toolbox\TDT\Functions\zBUS;'], ...
			[labpath 'Toolbox\Utilities;'], ...
			[labpath 'Toolbox\RFAnalyze;'], ...
			[labpath 'Toolbox\Robot\TDTRobot;'], ...
			[labpath 'Toolbox\UIutilities;'], ...
			[labpath 'Toolbox\structdlg;'], ...
