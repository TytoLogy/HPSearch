...
%------------------------------------------------------------------------
% Created: 4 February, 2010 from setrigpath.m (SJS)
%
% Revisions:
%------------------------------------------------------------------------
...
if ~nargin
	labpath = 'C:\Users\TytoLogyV102\main\'
	toolpath = 'C:\Users\TytoLogyV102\toolbox\'
else
...
%%% BEGIN ENTRIES %%%
	  ...
	  [labpath 'Experiments\RF;'], ...
	  [labpath 'Experiments\RFMPX;'], ...
